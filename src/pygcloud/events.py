...
from .models import GCPService, ServiceGroup, GroupName
...
def start_deploy(deployer_instance,
    ...
    the deployment task
    """
    execute_hooks(deployer_instance, what)
...
def before_deploy(deployer_instance, service: GCPService):
    ...
    """
    execute_hooks(deployer_instance, service)
...
def end_deploy(deployer_instance,
               what: Union[GCPService, ServiceGroup, GroupName]):
    """
    Prototype of entrypoint 'end_deploy'

    Executed at the very end of invocation of the
    the deployment task
    """
    execute_hooks(deployer_instance, what)
